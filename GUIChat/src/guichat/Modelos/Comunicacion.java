...
public class Comunicacion implements Serializable{
    ...
    public static enum MTypes{
        ...
        RQAMIGOS_INVITE, RQAMIGOS_DELETE, RQAMIGOS_ADD, RQAMIGOS_REJECT,
        RQAMIGOS_UPDATE, RQGRUPOS_UPDATE, RQGRUPOS_CREATE,RQGRUPOS_ADD,
        RQGRUPOS_INVITE, RQGRUPOS_DELETE, RQGRUPOS_REJECT, 
        ...
        RQAMIGOS_GETPET, RQGRUPOS_GETPET, RQMENSAJES_GETGRUPO,
        ACK, ACK_LOGIN,
        SEND_MENSAJE, SEND_GRUPO, SEND_CONECTADOS, SEND_DESCONECTADOS,
        SEND_AMIGOSCON, SEND_AMIGOSDES, SEND_GRUPOS, SEND_INFOGRUPO, SEND_MENSAJE_GRUPO, SEND_MENSAJES_GRUPOS,
